...
viagem_OrigemDestino <- svyby(~viagem_total, by = ~Origem+Destino, subset(dadosPNADc,VD2002=="Pessoa responsável"), svytotal, na.rm = TRUE)

cv_origemdestino <- cv(svyby(~viagem_total, by = ~Origem+Destino, subset(dadosPNADc,VD2002=="Pessoa responsável"), svytotal, na.rm = TRUE))
